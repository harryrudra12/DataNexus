...
class LawCode(Enum):
    ...
    IN_DPDP_2023 = "IN_DPDP_2023"  # backward-compatible alias
                ...
                if not result["passed"]:
                    ...
                    if rule.auto_fix:
                        ...
                        if fix_result["success"]:
                            ...
                            if context.get("allow_auto_fix_to_unblock", False):
                                allowed = True
    ...
    def _evaluate_rule(self, rule: ComplianceRule, target_country: str,
        ...
        try:
            eval_ctx = {
                ...
                "data":                  type("D", (), {**{"consent": type("Consent", (), {"allowed_purposes": [purpose]})(), "field_count": 0, "justified_field_count": 0, "encrypted_at_rest": True, "encrypted_in_transit": True, "required_clearance": 0}, **ctx.get("data_props", {})})(),
                "requester":             type("R", (), {**{"clearance_level": 999}, **ctx.get("requester", {})})(),
